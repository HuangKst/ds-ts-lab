...
import { Friend,Buddy, Colleague, SecureFriendContact, FriendPartial,EventPass, BuddyList, ColleagueV2 } from "./myTypes";
...
function secureFindFriends(
  ...
  console.log(intersection(friends, colleagues.current)+"yes");
